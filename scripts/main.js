...
`));
  ...
  var Level = class {
    constructor(options, onComplete, onReset) {
      ...
      this.cellSize = Math.floor(2e3 / this.options.size) / 2;
      this.hasWon = false;
      this.moving = false;
      ...
      for (let i2 = 0; i2 < options.switches.length; i2++) {
        add([
          ...
          pos(options.switches[i2].x * this.cellSize, options.switches[i2].y * this.cellSize),
      ...
      keyPress("u", () => __async(this, null, function* () {
        if (this.hasWon)
          return;
      ...
      action(() => __async(this, null, function* () {
        ...
        if (get("switch").find((switchObj) => switchObj.isTouching(this.block))) {
    ...
    static addGrid(size14, goal) {
      let cSize = Math.floor(2e3 / size14) / 2;
      for (let i2 = 0; i2 < size14; i2++) {
        for (let j = 0; j < size14; j++) {
          let grid2 = [
            sprite(`grid`, { width: cSize, height: cSize, quad: quad(i2 % 4 * 0.25, j % 4 * 0.25, 0.25, 0.25) }),
            pos(i2 * cSize, j * cSize),
            "grid"
          ];
          if (goal && i2 >= goal.x && i2 <= goal.x + 4 && j >= goal.y && j <= goal.y + 4)
    ...
    wallAt(x, y) {
      let walls14 = get("wallCollision").concat(get("switchWallCollision"));
      for (let wall of walls14) {
        if (wall.hasPoint(vec2(x, y)) && wall.solid)
          return true;
      }
      return false;
    }
    handleMovement(direction) {
      return () => __async(this, null, function* () {
        ...
        for (let i2 = 0; i2 < 4; i2++) {
          switch (direction) {
            case "left":
              if (this.player.pos.x === this.block.pos.x + this.cellSize * 5 && this.player.pos.y === this.block.pos.y + this.cellSize * 2 && !this.wallAt(this.player.pos.x - 1, this.player.pos.y))
                this.block.moveBy(this.cellSize / -4, 0);
              this.player.moveBy(this.cellSize / -4, 0);
              break;
            case "right":
              if (this.player.pos.x === this.block.pos.x - this.cellSize && this.player.pos.y === this.block.pos.y + this.cellSize * 2 && !this.wallAt(this.player.pos.x + this.cellSize - 1, this.player.pos.y))
                this.block.moveBy(this.cellSize / 4, 0);
              this.player.moveBy(this.cellSize / 4, 0);
              break;
            case "up":
              if (this.player.pos.x === this.block.pos.x + this.cellSize * 2 && this.player.pos.y === this.block.pos.y + this.cellSize * 5 && !this.wallAt(this.player.pos.x, this.player.pos.y - 1))
                this.block.moveBy(0, this.cellSize / -4);
              this.player.moveBy(0, this.cellSize / -4);
              break;
            case "down":
              if (this.player.pos.x === this.block.pos.x + this.cellSize * 2 && this.player.pos.y === this.block.pos.y - this.cellSize && !this.wallAt(this.player.pos.x, this.player.pos.y + this.cellSize - 1))
                this.block.moveBy(0, this.cellSize / 4);
              this.player.moveBy(0, this.cellSize / 4);
              break;
          }
        ...
        switch (direction) {
          case "left":
            this.player.pos.x++;
          case "right":
            if (this.player.pos.x % this.cellSize !== 1)
              this.player.pos.x = this.player.pos.x - this.player.pos.x % this.cellSize + 1;
            break;
          case "up":
            this.player.pos.y++;
          case "down":
            if (this.player.pos.y % this.cellSize !== 1)
              this.player.pos.y = this.player.pos.y - this.player.pos.y % this.cellSize + 1;
            break;
        }
        sound.stop();
        this.moving = false;
  ...
  var goalX9 = 5;
  var goalY9 = 5;
  var walls9 = [{ x: 0, y: 1, dir: "horizontal", length: 1 }, { x: 6, y: 0, dir: "vertical", length: 2 }, { x: 1, y: 1, dir: "vertical", length: 3 }, { x: 6, y: 2, dir: "horizontal", length: 1 }, { x: 7, y: 2, dir: "vertical", length: 3 }, { x: 1, y: 5, dir: "vertical", length: 3 }, { x: 1, y: 9, dir: "vertical", length: 1 }, { x: 7, y: 5, dir: "horizontal", length: 3 }];
  var switchWalls9 = [{ x: 6, y: 2, dir: "vertical", length: 1 }, { x: 1, y: 8, dir: "vertical", length: 1 }];
  var switches9 = [{ x: 3, y: 6 }];
  var size9 = 10;
  var level9_default = { playerX: playerX9, playerY: playerY9, blockX: blockX9, blockY: blockY9, goalX: goalX9, goalY: goalY9, walls: walls9, switchWalls: switchWalls9, switches: switches9, size: size9 };
  ...
  var goalX10 = 5;
  var goalY10 = 8;
  var walls10 = [{ x: 12, y: 1, dir: "horizontal", length: 2 }, { x: 12, y: 14, dir: "horizontal", length: 2 }, { x: 1, y: 14, dir: "horizontal", length: 2 }, { x: 14, y: 1, dir: "vertical", length: 2 }, { x: 14, y: 12, dir: "vertical", length: 2 }, { x: 1, y: 1, dir: "vertical", length: 2 }, { x: 1, y: 12, dir: "vertical", length: 2 }, { x: 1, y: 1, dir: "horizontal", length: 2 }, { x: 14, y: 5, dir: "vertical", length: 5 }, { x: 1, y: 5, dir: "vertical", length: 5 }, { x: 4, y: 1, dir: "horizontal", length: 7 }, { x: 8, y: 14, dir: "horizontal", length: 3 }, { x: 4, y: 14, dir: "horizontal", length: 3 }];
  var switchWalls10 = [{ x: 7, y: 9, dir: "horizontal", length: 1 }, { x: 7, y: 14, dir: "horizontal", length: 1 }];
  var switches10 = [{ x: 13, y: 1 }, { x: 1, y: 13 }, { x: 13, y: 13 }, { x: 1, y: 1 }, { x: 7, y: 13 }, { x: 7, y: 1 }, { x: 13, y: 7 }, { x: 1, y: 7 }];
  var size10 = 15;
  var level10_default = { playerX: playerX10, playerY: playerY10, blockX: blockX10, blockY: blockY10, goalX: goalX10, goalY: goalY10, walls: walls10, switchWalls: switchWalls10, switches: switches10, size: size10 };
  ...
  var goalX11 = 5;
  var goalY11 = 5;
  var walls11 = [{ x: 1, y: 0, dir: "vertical", length: 3 }, { x: 2, y: 1, dir: "vertical", length: 3 }, { x: 3, y: 0, dir: "vertical", length: 3 }, { x: 0, y: 4, dir: "horizontal", length: 1 }, { x: 4, y: 3, dir: "horizontal", length: 3 }, { x: 8, y: 3, dir: "horizontal", length: 2 }, { x: 4, y: 1, dir: "vertical", length: 2 }, { x: 5, y: 0, dir: "vertical", length: 2 }, { x: 6, y: 1, dir: "vertical", length: 2 }, { x: 6, y: 1, dir: "horizontal", length: 3 }, { x: 7, y: 2, dir: "horizontal", length: 3 }, { x: 1, y: 4, dir: "vertical", length: 2 }, { x: 1, y: 7, dir: "vertical", length: 2 }];
  var switchWalls11 = [{ x: 7, y: 4, dir: "vertical", length: 6 }, { x: 1, y: 9, dir: "horizontal", length: 3 }, { x: 5, y: 9, dir: "horizontal", length: 1 }];
  var switches11 = [{ x: 0, y: 9 }, { x: 7, y: 5 }, { x: 4, y: 3 }, { x: 1, y: 6 }];
  var size11 = 10;
  var level11_default = { playerX: playerX11, playerY: playerY11, blockX: blockX11, blockY: blockY11, goalX: goalX11, goalY: goalY11, walls: walls11, switchWalls: switchWalls11, switches: switches11, size: size11 };
  ...
  var goalX12 = 0;
  var goalY12 = 0;
  var walls12 = [{ x: 8, y: 11, dir: "horizontal", length: 3 }, { x: 11, y: 6, dir: "vertical", length: 2 }, { x: 0, y: 11, dir: "horizontal", length: 7 }, { x: 6, y: 5, dir: "horizontal", length: 4 }, { x: 6, y: 0, dir: "vertical", length: 3 }];
  var switchWalls12 = [{ x: 1, y: 4, dir: "horizontal", length: 3 }, { x: 5, y: 5, dir: "horizontal", length: 1 }, { x: 10, y: 5, dir: "horizontal", length: 1 }];
  var switches12 = [{ x: 1, y: 9 }, { x: 5, y: 4 }, { x: 2, y: 2 }];
  var size12 = 12;
  var level12_default = { playerX: playerX12, playerY: playerY12, blockX: blockX12, blockY: blockY12, goalX: goalX12, goalY: goalY12, walls: walls12, switchWalls: switchWalls12, switches: switches12, size: size12 };
  ...
  var goalY13 = 3;
  var walls13 = [];
  var switchWalls13 = [{ x: 5, y: 4, dir: "horizontal", length: 1 }];
  var switches13 = [{ x: 5, y: 10 }, { x: 0, y: 3 }, { x: 10, y: 3 }, { x: 0, y: 10 }, { x: 10, y: 10 }, { x: 1, y: 4 }, { x: 9, y: 4 }, { x: 5, y: 2 }];
  var size13 = 11;
  var level13_default = { playerX: playerX13, playerY: playerY13, blockX: blockX13, blockY: blockY13, goalX: goalX13, goalY: goalY13, walls: walls13, switchWalls: switchWalls13, switches: switches13, size: size13 };
  ...
  scene("level9", () => __async(void 0, null, function* () {
    yield addLevel(level9_default);
  }));
  scene("level10", () => __async(void 0, null, function* () {
    yield addLevel(level10_default);
  }));
  scene("level11", () => __async(void 0, null, function* () {
    yield addLevel(level11_default);
  }));
  scene("level12", () => __async(void 0, null, function* () {
    yield addLevel(level12_default);
  }));
  scene("level13", () => __async(void 0, null, function* () {
    yield addLevel(level13_default);
  }));
  function grid() {
